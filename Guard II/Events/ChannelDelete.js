...
module.exports = async (channel) => {
    ...
    ]}).catch(`${entry.executor} (\`${entry.executor.id}\`) tarafından \`${channel.name}\` \`${channel.id}\` isimli kanal silindi ve geri oluşturularak, yapan kişi yasaklandı.`)
